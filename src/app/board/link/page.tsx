		...
		<div className='grid min-h-svh w-full place-items-center'>
			<div className='grid gap-4'>
				...
				<Card>
					<CardHeader>
						<CardTitle>
							{metadata.data?.boardMetadata.title}
						</CardTitle>
						<CardDescription className='line-clamp-1'>
							{metadata.data?.boardMetadata.description}
						</CardDescription>
					</CardHeader>
					<CardContent>
						<div className='flex h-min w-auto items-center gap-5'>
							<Avatar className='size-12'>
								<AvatarImage
									src={
										metadata.data?.boardMetadata?.owner
											.avatarUrl ?? ''
									}
									alt='avatar'
								/>
						...
						<div className='space-y-4'>
							...
							<div className='*:data-[slot=avatar]:ring-secondary mb-3 flex -space-x-2 *:data-[slot=avatar]:ring-2 *:data-[slot=avatar]:grayscale'>
								{metadata.data?.boardMetadata?.collaborators.map(
									(collab) => (
										<Avatar
											key={collab._id}
											className='size-10'
				...
				<div>
					<p>
						By joining a board you agree to collaborate respectfully
						with other members
					</p>
				</div>
			</div>
