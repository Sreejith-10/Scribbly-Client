...
export function Navbar() {
  ...
  return (
    <nav className="bg-white shadow">
        ...
        <div className="flex justify-between h-16">
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" className="text-2xl font-bold text-primary">
              <Image src={"/icons/icon.png"} alt='logo' width={50} height={50} />
            </Link>
          </div>
          <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuLink className='font-medium text-sm' href='/'>Dashboard</NavigationMenuLink>
                </NavigationMenuItem>
                <NavigationMenuItem>
                  <NavigationMenuTrigger>Resources</NavigationMenuTrigger>
                  <NavigationMenuContent>
                    <ul className='grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]'>
                      <ListItem href='/' title='Docs'>Read documentation for more information</ListItem>
                    </ul>
                  </NavigationMenuContent>
                </NavigationMenuItem>
                <NavigationMenuItem>
                        ...
                        <NavigationMenuLink asChild>
                          ...
                          >
                            ...
                            <p className="text-sm leading-tight text-muted-foreground">
                              Upgrade to Scribbly Pro for advanced features and unlimited boards.
                            </p>
                          </a>
                        </NavigationMenuLink>
                      </li>
          ...
          <div className="-mr-2 flex items-center sm:hidden">
            <Button
              variant="ghost"
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary z-50"
      ...
      <MobileMenu isOpen={mobileMenuOpen} navItems={navItems} onClose={() => setMobileMenuOpen(false)} />
    </nav>
  )
}
