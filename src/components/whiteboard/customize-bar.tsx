...
export const CustomizeBar = () => {
	...
	const {currentShapeSelected, updateCurrentShapeSelected, changeShapeLayer} =
		useBoardStore();

	return (
		<div className="fixed top-5 left-5 z-50 py-6 px-6 rounded-lg shadow-md bg-white border border-zinc-300 border-opacity-30">
			<div className="space-y-4">
				...
				<div className="space-y-2">
					...
					<div className="space-x-3">
						<ToggleGroup
							type="single"
							className="space-x-2"
							onValueChange={(stroke) => setStrokeWidth(parseInt(stroke, 10))}>
							<ToggleGroupItem
								value={"5"}
								className="inline-grid size-10 border border-slate-200 rounded-xl hover:border hover:border-slate-200 place-content-center cursor-pointer">
				...
				<div className="space-y-2">
					...
					<div className="space-x-3">
						<Button
							onClick={() => {
								changeShapeLayer(currentShapeSelected!, 1);
							}}
							variant={"outline"}
							className="inline-grid size-10 border border-slate-200 rounded-xl hover:border hover:border-slate-200 place-content-center cursor-pointer">
							<LuArrowDown />
